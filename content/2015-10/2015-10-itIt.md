...
[@Berteh](http://github.com/berteh) ha contribuito a portare avanti il lavoro. Negli ultimi mesi ha lavorato su una [patch](http://bugs.scribus.net/view.php?id=13311) che permette di utilizzare parametri con gli script python.
