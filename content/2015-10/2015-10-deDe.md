...
Dies ist der erste monatliche Newsletter der Scribus-Community über Scribus und seine Entwicklung.
...
Deszo Markon, der diese neuen Zeichen kreiert, ist ein neu zu uns gestossener Entwickler. Auch wenn dieser Satz noch nicht zu 100% fertiggestellt ist, deckt er bereits mehr als 80% der Icons ab. Das Design kommt mit wenigen Farben aus, ist am Anfang etwas gewöhnungsbedürftig, aber es ist sehr erfrischend, ein neues, konsequentes Erscheinungsbild zu sehen.

Während der Integration dieser Piktogramme hat Craig Bradney, einer unserer langjährigen Entwickler, sich die Zeit genommen, die Themenauswahl in Scribus zu verstärken: man kann nun  aus verschiedenen Icon-Sammlungen auswählen. Somit kann der Anwender seine grafische Oberfläche besser personalisieren. Dazu kommt, dass es für Grafiker einfacher wird, neue Icon-Sets zur Verfügung zu stellen.
...
„Eines Tages werden die Leute feststellen, dass _#Inkscape_ nicht nur zum Erstellen von Firmen-Logos, _#GIMP_ nicht nur für die Foto-Bearbeitung und _#Scribus_ nicht nur zum Erstellen von Community-Newslettern zu gebrauchen sind – obwohl sie alle diese Sachen sehr gut machen – dann eröffnet sich eine ganze Welt von Möglichkeiten. Es wäre toll, wenn meine geringen Bemühungen etwas dazu beitragen können, dies zu ändern“ _+Garry Patchett_
...
Ein neuer Scripter ist seit längerer Zeit in Arbeit. Momentan stecken wir bei der Portierung der neuen Engine von Qt4 nach Qt5 fest, insbesondere am Punkt wo wir das reale Signal und Slots über die Grenzen zwischen C++ und Python unter Verwendung von PyQt5 verbinden müssen.

Der aktuelle Code für den neuen Scripter befindet sich auf Github  
<https://github.com/aoloe/scribus-plugin-scripter>

Eure Hilfe ist uns sehr wertvoll und wir wissen es zu danken. Wer denkt, dass er uns helfen kann, soll sich bitte via dem Issue Tracker auf dem Repository oben melden.
