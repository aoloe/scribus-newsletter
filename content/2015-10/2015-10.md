...
```sh
$ scribus --python-script to-pdf.py --python-script-arg text "Welcome to Scribus" the-document.sla
```

Of course, a real world script will probably use the the path to a JSON file as the parameter and let the Python script process the data and fill multiple fields.
