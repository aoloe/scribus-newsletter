...
Depening on your workflow, a real world script could also use the path to a JSON file as the parameter and let the Python script process the data and fill multiple fields.
