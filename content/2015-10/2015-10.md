...
Of course, a real world script will probably use the path to a JSON file as the parameter and let the Python script process the data and fill multiple fields.
