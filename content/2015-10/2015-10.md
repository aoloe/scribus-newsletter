...
Depending on your workflow, a real world script with multiple arguments will probably use the path to a JSON file as the parameter and let the Python script process the data and fill multiple fields.
