...
Lately, there have been several very relevant advances in the Scribus user interface: a new icon set has been added to Scribus 1.5svn and with his [Indigo project](http://forums.scribus.net/index.php/topic,1617.0.html), Martins is creating an interactive proposal for the Properties Palette and the Toolbar.
